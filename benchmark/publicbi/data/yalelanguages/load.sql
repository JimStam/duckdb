...
INSERT INTO YaleLanguages_3 SELECT * FROM read_csv_auto('benchmark/publicbi/YaleLanguages_3.csv.gz');
INSERT INTO YaleLanguages_2 SELECT * FROM read_csv_auto('benchmark/publicbi/YaleLanguages_2.csv.gz');
INSERT INTO YaleLanguages_4 SELECT * FROM read_csv_auto('benchmark/publicbi/YaleLanguages_4.csv.gz');
INSERT INTO YaleLanguages_5 SELECT * FROM read_csv_auto('benchmark/publicbi/YaleLanguages_5.csv.gz');
INSERT INTO YaleLanguages_1 SELECT * FROM read_csv_auto('benchmark/publicbi/YaleLanguages_1.csv.gz');