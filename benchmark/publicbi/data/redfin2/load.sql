...
INSERT INTO Redfin2_2 SELECT * FROM read_csv_auto('benchmark/publicbi/Redfin2_2.csv.gz');
INSERT INTO Redfin2_1 SELECT * FROM read_csv_auto('benchmark/publicbi/Redfin2_1.csv.gz');
INSERT INTO Redfin2_3 SELECT * FROM read_csv_auto('benchmark/publicbi/Redfin2_3.csv.gz');