...
INSERT INTO IGlocations2_1 SELECT * FROM read_csv_auto('benchmark/publicbi/IGlocations2_1.csv.gz');
INSERT INTO IGlocations2_2 SELECT * FROM read_csv_auto('benchmark/publicbi/IGlocations2_2.csv.gz');