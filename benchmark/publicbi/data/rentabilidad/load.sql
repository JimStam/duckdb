...
INSERT INTO Rentabilidad_2 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_2.csv.gz');
INSERT INTO Rentabilidad_6 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_6.csv.gz');
INSERT INTO Rentabilidad_7 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_7.csv.gz');
INSERT INTO Rentabilidad_9 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_9.csv.gz');
INSERT INTO Rentabilidad_3 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_3.csv.gz');
INSERT INTO Rentabilidad_4 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_4.csv.gz');
INSERT INTO Rentabilidad_8 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_8.csv.gz');
INSERT INTO Rentabilidad_1 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_1.csv.gz');
INSERT INTO Rentabilidad_5 SELECT * FROM read_csv_auto('benchmark/publicbi/Rentabilidad_5.csv.gz');