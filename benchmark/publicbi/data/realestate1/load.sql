...
INSERT INTO RealEstate1_2 SELECT * FROM read_csv_auto('benchmark/publicbi/RealEstate1_2.csv.gz');
INSERT INTO RealEstate1_1 SELECT * FROM read_csv_auto('benchmark/publicbi/RealEstate1_1.csv.gz');